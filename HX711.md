...
**Moved to `HX711-new.md`** — the rewrite was executed and validated (30/30 macro runs, 0 faults). Goals, failure taxonomy, fixes, and test methodology all live there now.
